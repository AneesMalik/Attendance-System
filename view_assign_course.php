...
<head>
    ...
    <!-- Title Page-->
    <title>Assigned Course Details</title>
                    ...
                    <div class="content">
                        <div class="page-inner">
                            <div class="page-header">
                                <h4 class="page-title" style="font-weight: 800; font-size: 20px;">Search Assigned Courses&nbsp; <i class="fas fa-book"></i></h4>
                            </div>
                                ...
                                <div class="row">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover text-center" id="myTable">
                                            ...
                                            <tbody>
                                                <?php
                                                    $sql_all = "SELECT * FROM `assign_course`";
                                                    $result_all=mysqli_query($ob->config(),$sql_all);
                                                    while($row_all=mysqli_fetch_assoc($result_all))
                                                    {
                                                ?>
                                                <tr>
                                                    <td style="vertical-align: middle; color: black;"><?php echo $row_all['c_name'];?></td>
                                                    <td style="vertical-align: middle; color: black;"><?php echo $row_all['c_sem'];?></td>
                                                    <td style="vertical-align: middle; color: black;"><?php echo $row_all['c_prog'];?></td>
                                                    <td style="vertical-align: middle; color: black;"><?php echo $row_all['c_inst'];?></td>
                                                    <td style="vertical-align: middle; color: black;"><?php echo $row_all['c_dept'];?></td>
                                                    <td style="vertical-align: middle;">
                                                        <button class="btn btn-info update_data" data-toggle="modal" data-target="#up_dept" id="update" data-id="<?php echo $row_all['c_id'];?>"><i class="fas fa-pen"></i></button>

                                                        <button class="btn btn-danger del_data" data-toggle="modal" data-target="#del_course" id="del_btn" data-id="<?php echo $row_all['c_id'];?>"><i class="fas fa-trash"></i></button>
                                                    </td>
                                                </tr>
                                                <?php
                                                    }
