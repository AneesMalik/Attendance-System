                    ...
                    <div class="content">
                        <div class="page-inner">
                            <div class="page-header">
                                <h4 class="page-title" style="font-weight: 800; font-size: 20px;">Search Lectures&nbsp; <i class="fas fa-user-clock"></i></h4>
                            </div>
                                ...
                                <div class="row">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover text-center" id="myTable">
                                            ...
                                            <tbody>
                                                <?php
                                                    $sql_all = "SELECT * FROM `assign_time`";
                                                    $result_all=mysqli_query($ob->config(),$sql_all);
                                                    while($row_all=mysqli_fetch_assoc($result_all))
                                                    {
                                                ?>
                                                <tr>
                                                    <!-- <td><?php //echo $row_all['lec_name'];?></td>
                                                    <td><?php //echo $row_all['lec_code'];?></td> -->
                                                    <td style="vertical-align: middle; color: black;"><?php echo $row_all['t_program'];?></td>
                                                    <td style="vertical-align: middle; color: black;"><?php echo $row_all['tcourse_inst'];?></td>
                                                    <td style="vertical-align: middle; color: black;"><?php echo $row_all['tcourse_name'];?></td>
                                                    <td style="vertical-align: middle; color: black;"><?php echo $row_all['tclass_batch'];?></td>
                                                    <td style="vertical-align: middle; color: black;"><?php echo $row_all['room'];?></td>
                                                    <td style="vertical-align: middle; color: black;"><?php echo $row_all['day'];?></td>
                                                    <td style="vertical-align: middle; color: black;"><?php echo $row_all['lec_time_from'];?></td>
                                                    <td style="vertical-align: middle; color: black;"><?php echo $row_all['lec_time_to'];?></td>
                                                    <td style="vertical-align: middle;">
                                                        <button style="margin-bottom: 5px;" class="btn btn-info update_data" data-toggle="modal" data-target="#up_dept" id="update" data-id="<?php echo $row_all['room_id'];?>"><i class="fas fa-pen"></i></button>

                                                        <button style="margin-top: 5px;" class="btn btn-danger del_data" data-toggle="modal" data-target="#del_course" id="del_btn" data-id="<?php echo $row_all['room_id'];?>"><i class="fas fa-trash"></i></button>
                                                    </td>
                                                </tr>
                                                <?php
                                                    }
