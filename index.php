    ...
    <div class="page-wrapper" style="background-color: transparent;">
        ...
        <div class="page-container2" style="background-color: transparent;">
            ...
            <div class="welcome" style="margin-top: 150px;">
                <p style="font-size: 25px; text-align: center;">Welcome <?php echo $row['pro_name']; ?></p>
            </div>

            <div class="pic" style="padding-left: 374px; margin-top: 60px;">
                <img src="<?php echo('std_profilephoto/').$row['pro_photo']; ?>" style="height: 300px; width: 300px;border-radius: 100%;">
            </div>
            <!-- END PAGE CONTAINER-->
        </div>
